...
- [导出输出数据](#导出输出数据)
- [创建测试对象](#创建测试对象)
- [查看、检查、统计、属性](#查看检查统计属性)
- [set_option、reset_option、describe_option 设置显示要求](#set_optionreset_optiondescribe_option-设置显示要求)
- [累计统计](#累计统计)
- [窗口计算(滚动计算)](#窗口计算滚动计算)
- [数据清理](#数据清理)
- [数据处理：Filter、Sort](#数据处理filtersort)
- [数据选取](#数据选取)
- [数据处理 GroupBy 透视](#数据处理-groupby-透视)
- [时间处理 时间序列](#时间处理-时间序列)
- [常用备忘](#常用备忘)
- [样式显示](#样式显示)
- [表格中的直方图，sparkline 图形](#表格中的直方图sparkline-图形)
- [可视化](#可视化)
- [Jupyter notebooks 问题](#jupyter-notebooks-问题)
